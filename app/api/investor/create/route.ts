...
export async function POST(request: Request) {
  ...
  const { email, investmentAmount, forceCreate, utm_source, utm_medium, utm_campaign, utm_content, utm_term } = body
  ...
  try {
    ...
    // No existing investors - create a new one with minimal info
    // First create a basic individual profile (will be updated in Step 2)
